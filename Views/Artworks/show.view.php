...
<div>
  <form method = "post" action = "Comment?id=<?=$artwork['id']?>">
    ...
    <button type="submit" class="flex w-auto justify-center rounded-md bg-orange-600 px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:bg-orange-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">Register</button>
  </form>
  <ul>
